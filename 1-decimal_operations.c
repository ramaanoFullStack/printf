...
/**
* print_d - Start
* @array_list: Store the value of arguments
...
/**
* print_i - Start
* @array_list: Store list numbers
* Return: Number print
*/
int print_i(va_list array_list)
{
return (print_d(array_list));
}
